...
public class Main {
    public static void main(String[] args)
    {
        ...
        Book book = new Book(1, "Sample domain.entities.Book", "A book description", "2023", "1234567890", 10, author);
        ...
        DbConnection dbconnection = new DbConnection("jdbc:mysql://localhost:3306/library", "root", "");
